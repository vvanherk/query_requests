...
select * from pctl_covtermmodelval;
select * from pctl_covtermmodeltype;
select * from pctl_covtermlookup;
select * from pctl_covterm;
select * from pctl_covtermmodeltype;

select * from pc_formpatterncovterm;

select * from pctl_covtermusetype;

select * from pcx_calccovterm_cg c
where c.covtermvalue_cg ='140'
;
